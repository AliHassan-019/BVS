...
/* Exported constants --------------------------------------------------------*/
/* USER CODE BEGIN EC */
extern volatile uint8_t limit_switch_activated;
...
#define Lim_Switch_1_GPIO_Port GPIOB
#define Lim_Switch_1_EXTI_IRQn EXTI0_IRQn
#define Lim_Switch_2_Pin GPIO_PIN_1
#define Lim_Switch_2_GPIO_Port GPIOB
#define Lim_Switch_2_EXTI_IRQn EXTI1_IRQn
#define ON_BOARD_Pin GPIO_PIN_3
#define ON_BOARD_GPIO_Port GPIOB
